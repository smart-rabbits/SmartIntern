...
<!-- End Table with stripped rows -->
            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="../updatemarks" method="POST" autocomplete="off" aria-autocomplete="off" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-6">
                  ...
                  <input type="number" step=".01" class="form-control" id="marks_sv" name="marks_sv" min="1" max="100">
                </div>
                <div class="col-md-6">
